...
```{r dplot, fig.align="center", fig.cap="\\label{fig:dplot} Density plot by score", out.width='75%', fig.pos='H'}
# density plot
ggplot(data = Data) +
...
```{r, fig.cap="\\label{fig:model1} Odds Ratio Graph Based on GLM Model ", out.width='75%', fig.pos='H'}
# odds plot
plot_model(fit3, show.values = TRUE,
           title = "Odds (price)", show.p = TRUE)
```

```{r, fig.cap="\\label{fig:predmodel} Probability of Pass for Italy \\& New Zealand ", out.width='75%', fig.pos='H'}
# prediction plot
plot_model(fit3,
           type = "pred", title = "",
