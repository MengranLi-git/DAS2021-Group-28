...
```{r, fig.cap="\\label{fig:predmodel} Probability of Pass for Italy \\& New Zealand ", out.width='75%', fig.pos='H',fig.align='center', fig.height= 3}
# prediction plot
plot_model(fit3,
           type = "pred", title = "",
