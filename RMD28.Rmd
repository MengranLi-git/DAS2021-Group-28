...
For the category varibales, we should check the percentages of pass and fail. According to the data, using the tabyl function to display the proportion of score variables in different countries.
...
Lüdecke D, 2021, _sjPlot: Data Visualization for Statistics in Social Science_, R package
version 2.8.8, <Ref: https://CRAN.R-project.org/package=sjPlot>.
